...
class WOOAPP_API_XML_Handler implements WOOAPP_API_Handler {
	...
	public function __construct() {
		...
		add_filter( 'woocommerce_mobapp_api_report_response', array( $this, 'format_sales_report_data' ), 100 );

		// tweak product response data
		add_filter( 'woocommerce_mobapp_api_product_response', array( $this, 'format_product_data' ), 100 );
	}
	...
	public function generate_response( $data ) {
		...
		switch ( $root_element ) {
			...
			default:
				$data = apply_filters( 'woocommerce_mobapp_api_xml_data', $data, $root_element );
				break;
		}
